...
template void EntityManager::Emplace<SpriteComponent>(Entity* entity, SpriteSheet*, int);
...
template void EntityManager::Emplace<CollisionComponent>(Entity* entity, float, float, float, float, bool);
